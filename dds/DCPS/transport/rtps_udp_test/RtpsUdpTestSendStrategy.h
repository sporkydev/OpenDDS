...
class RtpsUdpTestDataLink;
typedef RcHandle<RtpsUdpTestDataLink> RtpsUdpTestDataLink_rch;

class OpenDDS_Rtps_Udp_Test_Export RtpsUdpTestSendStrategy
  : public TransportSendStrategy {
public:
  RtpsUdpTestSendStrategy(RtpsUdpTestDataLink* link,
  ...
  struct OverrideToken {
    explicit OverrideToken(RtpsUdpTestSendStrategy* outer) : outer_(outer) {}
    ~OverrideToken();
    RtpsUdpTestSendStrategy* outer_;
  };
