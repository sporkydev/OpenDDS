...
class OpenDDS_Rtps_Udp_Test_Export RtpsUdpTestReceiveStrategy
  : public TransportReceiveStrategy<RtpsTransportHeader, RtpsSampleHeader>,
    public ACE_Event_Handler {
public:
  explicit RtpsUdpTestReceiveStrategy(RtpsUdpTestDataLink* link, const GuidPrefix_t& local_prefix);
