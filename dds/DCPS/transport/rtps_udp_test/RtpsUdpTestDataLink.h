...
#include "RtpsUdpTestSendStrategy_rch.h"
#include "RtpsUdpTestReceiveStrategy.h"
#include "RtpsUdpTestReceiveStrategy_rch.h"
...
class RtpsUdpTestInst;
class RtpsUdpTestTransport;
class ReceivedDataSample;
typedef RcHandle<RtpsUdpTestInst> RtpsUdpTestInst_rch;
typedef RcHandle<RtpsUdpTestTransport> RtpsUdpTestTransport_rch;

class OpenDDS_Rtps_Udp_Test_Export RtpsUdpTestDataLink : public DataLink {
public:

  RtpsUdpTestDataLink(const RtpsUdpTestTransport_rch& transport,
  ...
  RtpsUdpTestInst_rch config() const;
...
private:
  ...
  RtpsUdpTestInst_rch config_;
  TransportReactorTask_rch reactor_task_;

  RtpsUdpTestSendStrategy_rch send_strategy_;
  RtpsUdpTestReceiveStrategy_rch recv_strategy_;
  ...
  struct MultiSendBuffer : TransportSendBuffer {
    ...
    MultiSendBuffer(RtpsUdpTestDataLink* outer, size_t capacity)
  ...
  struct RtpsWriter {
    ...
    //Only accessed with RtpsUdpTestDataLink lock held
  ...
  typedef void (RtpsUdpTestDataLink::*PMF)();

  struct TimedDelay : ACE_Event_Handler {

    TimedDelay(RtpsUdpTestDataLink* outer, PMF function,
  ...
  struct HeartBeat : ReactorInterceptor {
    ...
    explicit HeartBeat(ACE_Reactor* reactor, ACE_thread_t owner, RtpsUdpTestDataLink* outer, PMF function)
  ...
  public:
    HeldDataDeliveryHandler(RtpsUdpTestDataLink* link)
      : link_(link) {
      }
