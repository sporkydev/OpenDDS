...
TransportImpl_rch
RtpsUdpTestInst::new_impl(const TransportInst_rch& inst)
{
  return make_rch<RtpsUdpTestTransport>(inst);
}

int
RtpsUdpTestInst::load(ACE_Configuration_Heap& cf,
...
size_t
RtpsUdpTestInst::populate_locator(OpenDDS::DCPS::TransportLocator& info) const
{
