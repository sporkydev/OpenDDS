...
#include "RtpsUdpTestDataLink_rch.h"
...
class OpenDDS_Rtps_Udp_Test_Export RtpsUdpTestTransport : public TransportImpl {
public:
  RtpsUdpTestTransport(const TransportInst_rch& inst);
